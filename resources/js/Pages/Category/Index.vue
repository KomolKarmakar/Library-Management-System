...
const filteredCategories = computed(() => {return props.categories.data.filter((category) =>category.name.toLowerCase().includes(searchQuery.value.toLowerCase()));});
const id = ref(null);
</script>
    ...
    <authenticated-layout>
        <div class="bg-white p-8 rounded-md w-full">
            <div class="flex items-center justify-between pb-6">
                <div>
                    <span class="text-3xl">All Categories</span>
                </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <button
                                               ...
                                               @click="showModal = true; id.value = category.id">
                                                <svg
                                                    class="w-6 h-6"
                                                    fill="currentColor"
                                                    viewBox="0 0 20 20"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <!-- ✅ Only show delete link if id is set -->
                <Link
                    v-if="id !== null"
                    as="button"
                    method="delete"
